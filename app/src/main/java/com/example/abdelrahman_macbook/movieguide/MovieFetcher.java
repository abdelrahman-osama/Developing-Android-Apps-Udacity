...
public class MovieFetcher extends AsyncTask<String, Void, List<Movie>> {
    ...
    protected List<Movie> doInBackground(String... strings) {
        ...
        try {
            ...
            final String BASE_URL = "http://api.themoviedb.org/3/movie/" + sortBy;
    ...
    private String getYear(String date){
        final SimpleDateFormat dateD = new SimpleDateFormat("yyyy-MM-dd", Locale.US);
        final Calendar cal = Calendar.getInstance();
        try{
            cal.setTime(dateD.parse(date));
    ...
    private List<Movie> extractData(String moviesJsonStr) throws JSONException {
        ...
        JSONArray moviesArray = movieJson.getJSONArray(ARRAY_OF_MOVIES);
        int moviesL = moviesArray.length();
        ...
        for(int i = 0; i < moviesL; ++i) {
            ...
            movies.add(new Movie(title, poster, overview, releaseDate, voteAverage, movieId));
